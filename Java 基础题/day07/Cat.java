...
public class Cat {
    ...
    public void eat() {
        System.out.printf("%1s的%1s正在吃鱼.....", color, breed);
    }

    public void catchMouse() {
        System.out.printf("%1s的%1s正在逮老鼠....", color, breed);
    }
...
class Dog {
    ...
    public void eat() {
        System.out.printf("%1s的%1s正在啃骨头.....", color, breed);
    }

    public void lookHome() {
        System.out.printf("%1s的%1s正在看家....", color, breed);
    }
